            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 9];
                    case 4: return [4 /*yield*/, this.Cache.getItem('federatedInfo')];
                    case 5:
                        ...
                        return [3 /*break*/, 9];
                    case 6: return [4 /*yield*/, this.Auth.currentSession()];
                    case 7:
                        session = _c.sent();
                        headers = {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 12:
                        ...
                        response = {
                            data: {},
                            errors: [new GraphQLError_1.GraphQLError(err_1.message)],
                        };
                        return [3 /*break*/, 13];
                    case 13:
