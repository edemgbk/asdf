...
var SubscriptionProcessor = /** @class */ (function () {
    ...
    SubscriptionProcessor.prototype.getAuthorizationInfo = function (model, transformerMutationType, userCredentials, cognitoTokenPayload, oidcTokenPayload) {
        ...
        var result;
        var rules = utils_1.getAuthorizationRules(model, transformerMutationType);
        ...
        if (apiKeyAuth) {
            return { authMode: api_1.GRAPHQL_AUTH_MODE.API_KEY, isOwner: false };
        }
        ...
        if (userCredentials === USER_CREDENTIALS.unauth ||
            ...
            if (iamPublicAuth) {
                return { authMode: api_1.GRAPHQL_AUTH_MODE.AWS_IAM, isOwner: false };
            }
        ...
        var groupAuthRules = rules.filter(function (rule) { return rule.authStrategy === 'groups' && rule.provider === 'userPools'; });
        ...
        groupAuthRules = rules.filter(function (rule) { return rule.authStrategy === 'groups' && rule.provider === 'oidc'; });
