...
var AsyncStorageAdapter = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        opType = (_b.sent())
                            ? types_1.OpType.UPDATE
                            : types_1.OpType.INSERT;
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 9];
                    case 7:
                        if (!(opType === types_1.OpType.INSERT)) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.db.save(item, storeName_1)];
                    case 8:
                        _b.sent();
                        result.push([instance, opType]);
    ...
    AsyncStorageAdapter.prototype.query = function (modelConstructor, predicate, pagination) {
        return __awaiter(this, void 0, void 0, function () {
            var storeName, namespaceName, predicates, predicateObjs_1, type_1, idPredicate, id, record, _a, x, all_1, filtered, all;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        storeName = this.getStorenameForModel(modelConstructor);
                        ...
                        predicates = predicates_1.ModelPredicateCreator.getPredicates(predicate);
                        ...
                        idPredicate = predicateObjs_1.length === 1 &&
                            predicateObjs_1.find(function (p) { return types_1.isPredicateObj(p) && p.field === 'id' && p.operator === 'eq'; });
                    ...
                    case 5:
                        ...
                        filtered = predicateObjs_1
                            ? all_1.filter(function (m) { return util_1.validatePredicate(m, type_1, predicateObjs_1); })
                            : all_1;
                        return [4 /*yield*/, this.load(namespaceName, modelConstructor.name, this.inMemoryPagination(filtered, pagination))];
                    case 6: return [2 /*return*/, _b.sent()];
                    case 7: return [4 /*yield*/, this.db.getAll(storeName, pagination)];
                    case 8:
                        all = _b.sent();
