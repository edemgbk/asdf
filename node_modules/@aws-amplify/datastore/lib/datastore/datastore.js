...
var DataStore = /** @class */ (function () {
    function DataStore() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/];
                    case 3:
                        this.storage = new storage_1.ExclusiveStorage(schema, namespaceResolver, getModelConstructorByModelName, modelInstanceCreator);
                    ...
                    case 5:
                        ...
                        if (aws_appsync_graphqlEndpoint) {
                            ...
                            this.sync = new sync_1.SyncEngine(schema, namespaceResolver, syncClasses, userClasses, this.storage, modelInstanceCreator, this.maxRecordsToSync, this.syncPageSize, this.conflictHandler, this.errorHandler);
        ...
        this.query = function (modelConstructor, idOrCriteria, pagination) { return __awaiter(_this, void 0, void 0, function () {
