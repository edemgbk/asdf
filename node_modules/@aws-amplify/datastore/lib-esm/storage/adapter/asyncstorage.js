...
import { exhaustiveCheck, getIndex, getIndexFromAssociation, isModelConstructor, traverseModel, validatePredicate, } from '../../util';
                ...
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        filtered = predicateObjs_1
                            ? all_1.filter(function (m) { return validatePredicate(m, type_1, predicateObjs_1); })
                            : all_1;
